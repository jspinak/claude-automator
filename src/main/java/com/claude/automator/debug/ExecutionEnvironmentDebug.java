...
public class ExecutionEnvironmentDebug implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            System.out.println("   After override - canCaptureScreen: " + ExecutionEnvironment.getInstance().canCaptureScreen());
        ...
        System.out.println("\n=== DEBUG COMPLETE ===");
        System.out.println("If Brobot capture is black but direct Robot works, the issue is ExecutionEnvironment.canCaptureScreen()");
    ...
    private double analyzeBlackPixels(BufferedImage img) {
        ...
        for (int i = 0; i < samples; i++) {
            ...
            if (img.getRGB(x, y) == 0xFF000000) blackCount++;
        }
