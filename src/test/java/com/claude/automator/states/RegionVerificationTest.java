 ...
 */
public class RegionVerificationTest {
    ...
    public void testLowerLeftQuarter() {
        ...
        System.out.println("  Width: " + lowerLeftQuarter.getW() + " (expected: 960 for 1920 width)");
        System.out.println("  Height: " + lowerLeftQuarter.getH() + " (expected: 540 for 1080 height)");
    ...
    public void testAllQuarters() {
        ...
        System.out.println("|  " + upperLeft.getW() + "x" + upperLeft.getH() + "       |  " + upperRight.getW() + "x" + upperRight.getH() + "       |");
        System.out.println("+----------------+----------------+");
        System.out.println("|  Lower Left    |  Lower Right   |");
        System.out.println("|  (0," + lowerLeft.getY() + ")       |  (" + lowerRight.getX() + "," + lowerRight.getY() + ")     |");
        System.out.println("|  " + lowerLeft.getW() + "x" + lowerLeft.getH() + "       |  " + lowerRight.getW() + "x" + lowerRight.getH() + "       |");
        System.out.println("+----------------+----------------+");
    }
}