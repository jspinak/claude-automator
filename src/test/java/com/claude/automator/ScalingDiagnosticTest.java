...
import io.github.jspinak.brobot.startup.BrobotApplicationContextInitializer;
...
public class ScalingDiagnosticTest {
    ...
    public static void setup() {
        ...
        BrobotApplicationContextInitializer initializer = new BrobotApplicationContextInitializer();
    ...
    public void diagnoseScaling() throws Exception {
        ...
        System.out.println("   System property 'brobot.dpi.scaling.disabled': " + 
            System.getProperty("brobot.dpi.scaling.disabled"));
        System.out.println("   System property 'sun.java2d.dpiaware': " + 
        ...
        System.out.println("   Physical (DisplayMode): " + mode.getWidth() + "x" + mode.getHeight());
        System.out.println("   Logical (Toolkit): " + screenSize.getWidth() + "x" + screenSize.getHeight());
        ...
        try {
            ...
            System.out.println("     Original size: " + patternImage.getWidth() + "x" + patternImage.getHeight());
            ...
            if (Settings.AlwaysResize != 1.0f) {
                ...
                System.out.println("     Would be resized to: " + resizedWidth + "x" + resizedHeight);
            }
        } catch (Exception e) {
        ...
        try {
            ...
            System.out.println("   Capture size: " + captureImage.getWidth() + "x" + captureImage.getHeight());
            System.out.println("   Matches physical resolution: " + 
            ...
            System.out.println("   50x50 region actual size: " + 
                regionImage.getWidth() + "x" + regionImage.getHeight());
        ...
        try {
            ...
            for (float factor : testFactors) {
                ...
                try {
                    ...
                    System.out.println("   AlwaysResize=" + factor + ": FOUND (score=" + 
        ...
        if (Settings.AlwaysResize != 1.0f) {
            System.out.println("   ⚠ Patterns are being resized by factor: " + Settings.AlwaysResize);
        } else {
