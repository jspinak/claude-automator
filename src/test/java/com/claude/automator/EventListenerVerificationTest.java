...
/**
 * Test to verify that SearchRegionDependencyInitializer receives events properly
 * after fixing the circular dependency issue.
 */
@SpringBootTest
...
public class EventListenerVerificationTest {
    
    @Autowired
    private SearchRegionDependencyInitializer searchRegionDependencyInitializer;
    ...
    public void testSearchRegionDependencyInitializerReceivesEvent() {
        ...
        assertNotNull(searchRegionDependencyInitializer, 
        ...
        assertTrue(searchRegionDependencyInitializer.isInitialized(), 
        ...
        System.out.println("   - Is initialized after event: " + searchRegionDependencyInitializer.isInitialized());
    }
}