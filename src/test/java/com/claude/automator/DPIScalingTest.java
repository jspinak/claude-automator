...
public class DPIScalingTest {
    ...
    public void testScalingSettings() throws Exception {
        ...
        System.out.println("Physical resolution: " + displayMode.getWidth() + "x" + displayMode.getHeight());
        System.out.println("Logical resolution: " + screenSize.getWidth() + "x" + screenSize.getHeight());
        ...
        try {
            ...
            System.out.println("Pattern size: " + pattern.getBImage().getWidth() + "x" + pattern.getBImage().getHeight());
            ...
            for (float factor : resizeFactors) {
                ...
                System.out.println("  Resized pattern size: " + 
                    (int)(pattern.getBImage().getWidth() * factor) + "x" + 
