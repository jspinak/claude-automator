...
@Component
public class RawConsoleOutputTest {
    ...
    public static void main(String[] args) {
        ...
        ConfigurableApplicationContext context = SpringApplication.run(RawConsoleOutputTest.class, args);
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (line.contains("Find") || line.contains("✗") || line.contains("✓")) {
                    ...
                    System.out.println("       Bytes: " + java.util.Arrays.toString(line.getBytes()));
                }
            }
            scanner.close();
