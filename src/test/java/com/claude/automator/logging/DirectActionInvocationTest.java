...
public class DirectActionInvocationTest {
    ...
    public static void main(String[] args) {
        ...
        ConfigurableApplicationContext context = SpringApplication.run(DirectActionInvocationTest.class, args);
    ...
    private void runTest() {
        ...
        try {
            ...
            ActionResult actionResult = actionResultFactory.init(findOptions, "Test Find Action", objectCollection);
