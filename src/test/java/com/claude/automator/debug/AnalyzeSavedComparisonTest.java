 ...
 */
public class AnalyzeSavedComparisonTest {
    ...
    private void compareImages(BufferedImage img1, BufferedImage img2) {
        ...
        System.out.println("  Slightly different (diff < 10): " + slightlyDifferent + " (" + 
            String.format("%.1f%%", (slightlyDifferent * 100.0 / totalPixels)) + ")");
        System.out.println("  Moderately different (10-50): " + moderatelyDifferent + " (" + 
            String.format("%.1f%%", (moderatelyDifferent * 100.0 / totalPixels)) + ")");
        System.out.println("  Very different (> 50): " + veryDifferent + " (" + 
        ...
        double similarity = (identicalPixels + slightlyDifferent * 0.9 + moderatelyDifferent * 0.5) / totalPixels;
