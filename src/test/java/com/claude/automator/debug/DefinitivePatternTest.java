 ...
 */
public class DefinitivePatternTest {
    ...
    public void proveLoadingMethodsAreIdentical() throws Exception {
        ...
        System.out.println("\n=== CONCLUSION ===");
        System.out.println("If both methods (file path and BufferedImage) produce the same results,");
    ...
    private void testWithBufferedImage(ScreenImage screenshot, File patternFile) {
        try {
            ...
            System.out.println("  Pattern loaded: " + patternImg.getWidth() + "x" + patternImg.getHeight());
