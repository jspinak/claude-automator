 ...
 */
public class ResolutionMysteryTest {
    ...
    public void investigateResolutionChanges() throws Exception {
        ...
        try {
            ...
            System.out.println("   Toolkit Screen Size: " + screenSize.getWidth() + "x" + screenSize.getHeight());
            ...
            if (mode.getWidth() != screenSize.getWidth()) {
                ...
                System.out.println("     Logical: " + screenSize.getWidth() + "x" + screenSize.getHeight());
        ...
        for (int i = 0; i < 5; i++) {
            ...
            System.out.println("   Capture " + (i+1) + ": " + img.getWidth() + "x" + img.getHeight());
            Thread.sleep(500);
        }
