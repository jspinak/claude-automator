 ...
 */
public class PhysicalResolutionCaptureTest {
    ...
    public void testPhysicalResolutionCapture() throws Exception {
        ...
        if (capture.getWidth() == 1536 && capture.getHeight() == 864) {
            ...
            System.out.println("   Scaled to: " + scaledCapture.getWidth() + "x" + scaledCapture.getHeight());
    ...
    private void testRobotConfigurations() {
        try {
            ...
            try {
                ...
                System.out.println("     Captured: " + beyondCapture.getWidth() + "x" + beyondCapture.getHeight());
