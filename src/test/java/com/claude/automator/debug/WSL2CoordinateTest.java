 ...
 */
public class WSL2CoordinateTest {
    ...
    public void testCoordinateSystemDiscrepancy() {
        ...
        try {
            ...
            for (int i = 0; i < screens.length; i++) {
                ...
                System.out.printf("  Bounds: x=%d, y=%d, width=%d, height=%d%n", 
            ...
            System.out.printf("SikuliX primary screen: %dx%d at (%d,%d)%n", 
            ...
            org.sikuli.script.Region directRegion = new org.sikuli.script.Region(
            ...
            org.sikuli.script.Region screenRegion = sikuliScreen.newRegion(
                0, screenHeight/2, screenWidth/2, screenHeight/2
            );
            ...
            System.out.printf("Screen ROI: x=%d, y=%d, w=%d, h=%d%n", 
            ...
            boolean coordinatesMatch = (rect.x == 100 && rect.y == 100 && 
                                       rect.width == 100 && rect.height == 100);
            System.out.printf("Coordinates preserved: %s%n", coordinatesMatch);
            if (!coordinatesMatch) {
                System.out.printf("Expected: (100,100,100,100), Got: (%d,%d,%d,%d)%n",
            ...
            if (scaleX != 1.0 || scaleY != 1.0) {
                System.out.println("WARNING: Display scaling detected! This could cause coordinate mismatches.");
            }
