 ...
 */
public class IDEScreenshotReplicationTest {
    ...
    private void checkPixelQuality(BufferedImage image) {
        ...
        System.out.println("  Pixel variations in 20px line: " + variations + 
    ...
    private void compareImages(BufferedImage img1, BufferedImage img2) {
        ...
        if (differences == 0) {
            ...
            System.out.println("  ✗ Images differ at " + differences + " pixels (" + 
    ...
    public void captureMultipleScreenshotsForComparison() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.println("  IDE saved: " + ideFile.getName() + " (" + 
                             ideShot.getImage().getWidth() + "x" + ideShot.getImage().getHeight() + ")");
            ...
            System.out.println("  Brobot saved: " + brobotFile.getName() + " (" + 
                             brobotShot.getImage().getWidth() + "x" + brobotShot.getImage().getHeight() + ")");
