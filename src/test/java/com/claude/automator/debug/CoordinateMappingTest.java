...
public class CoordinateMappingTest {
    ...
    public void mapCoordinateSystem() throws Exception {
        ...
        System.out.printf("Screen reports: %dx%d at (%d,%d)%n", 
        ...
        String[] colors = {"red", "green", "blue", "yellow", "cyan", "magenta", "white", "orange", "gray"};
        int gridSize = 3;
        int boxSize = 80;
        ...
        for (int row = 0; row < gridSize; row++) {
            for (int col = 0; col < gridSize; col++) {
                ...
                System.out.printf("Position %d,%d: Highlighting at (%d,%d) in %s%n", 
    ...
    public void testVirtualDisplay() {
        ...
        try {
            ...
            for (GraphicsDevice device : devices) {
                ...
                System.out.printf("  Display Mode: %dx%d @ %dHz, %d-bit%n",
                ...
                System.out.printf("  Full screen supported: %s%n", 
                    device.isFullScreenSupported());
                System.out.printf("  Display change supported: %s%n", 
