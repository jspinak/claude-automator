 ...
 */
public class PatternMatchingDiagnosticTest {
    ...
    public void diagnosePatternMatching() throws Exception {
        ...
        for (String patternPath : patterns) {
            ...
            BufferedImage screenARGB = new BufferedImage(
            ...
            System.out.println("\nMethod 4: Both converted to RGB");
            BufferedImage screenRGB = new BufferedImage(
                screenImage.getWidth(),
                screenImage.getHeight(),
                BufferedImage.TYPE_INT_RGB);
    ...
    private void testWithFinder(BufferedImage searchImage, BufferedImage patternImage, String label) {
        try {
            ...
            for (double threshold : thresholds) {
                ...
                if (finder.hasNext()) {
                    ...
                    System.out.printf("  %s at %.2f: FOUND with score %.3f at (%d, %d)\n",
    ...
    private void testWithScreenFind(Screen screen, BufferedImage patternImage) {
        try {
            ...
            for (double threshold : thresholds) {
                ...
                if (match != null) {
                    System.out.printf("  Screen.exists at %.2f: FOUND with score %.3f at %s\n",
    ...
    private void testWithFilePath(Screen screen, String patternPath) {
        try {
            ...
            for (double threshold : thresholds) {
                ...
                if (match != null) {
                    System.out.printf("  File path at %.2f: FOUND with score %.3f at %s\n",
                        threshold, match.getScore(), match.getTarget());
                    return;
                }
            }
