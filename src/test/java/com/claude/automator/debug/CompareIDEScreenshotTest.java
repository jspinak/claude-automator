 ...
 */
public class CompareIDEScreenshotTest {
    
    @Test
    public void compareScreenshotMethods() throws Exception {
        System.out.println("=== SCREENSHOT COMPARISON TEST ===\n");
        System.out.println("Testing different screenshot capture methods to find the sharp one...\n");
        ...
        System.out.println("   Resolution: " + brobotCapture.getWidth() + "x" + brobotCapture.getHeight());
        ...
        System.out.println("   Resolution: " + primaryCapture.getWidth() + "x" + primaryCapture.getHeight());
        ...
        System.out.println("   Resolution: " + allCapture.getWidth() + "x" + allCapture.getHeight());
    ...
    private void testPatternOnScreenshots() {
        try {
            ...
            System.out.println("   Pattern size: " + pattern.getWidth() + "x" + pattern.getHeight());
    ...
    private void checkSharpness(BufferedImage image) {
        ...
        System.out.println("   Sharpness indicator: " + String.format("%.1f%%", sharpness) + 
                          " (higher = sharper)");
    }
